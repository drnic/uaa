...
public class ClientAdminEndpointsDocs extends AdminClientCreator {
    ...
    private static final FieldDescriptor[] idempotentFields = new FieldDescriptor[]{
        ...
        fieldWithPath("show-on-homepage").optional(null).type(BOOLEAN).description("Display client on home page"),
        fieldWithPath("app-launch-url").optional(null).type(STRING).description("Include home page link to client application"),
        fieldWithPath("app-icon").optional(null).type(STRING).description("Include home page icon for client application (base64 encoded image)"),
